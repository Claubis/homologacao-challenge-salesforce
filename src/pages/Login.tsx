...
export default function Login(){
    ...
    return(
        ...
        <div className="flex min-h-[100vh] bg-gray-100 dark:bg-gray-700 ">
            ...
            <div className="flex flex-col justify-center items-center gap-20 w-[60%] min-h-[100vh] border border-[#3EA0E7] p-10">

                <div>
                    <h1 className="text-5xl font-sen dark:text-white leading-20">Buscamos simplicidade até no momento de fazer seu login</h1>
                </div>
            ...
            <div className="flex justify-center items-center border border-[#3EA0E7] w-full bg-white">

                <div className="w-full max-w-xl p-4 rounded-md sm:p-8 dark:bg-gray-500 dark:text-gray-800">
                

                    <h3 className="mb-10 text-xl font-sen text-start dark:text-white">Não precisa ter conta na SalesForce</h3>
                    ...
                    <div className="my-6 space-y-4">
                        ...
                        <button onClick={() => signIn('google', { callbackUrl: 'http://localhost:3000/ProtectedPage' })} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-[#3EA0E7]">
                            ...
                            <p className="dark:text-white">Login com Google</p>
                        ...
                        <button aria-label="Login with GitHub" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-[#3EA0E7]">
                            ...
                            <p className="dark:text-white">Login com GitHub</p>
                        </button>
                        ...
                        <button aria-label="Login with Twitter" role="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-[#3EA0E7]">
                            ...
                            <p className="dark:text-white">Login com Linkedin</p>
                        </button>
                    ...
                    <form  action="post" name="formLogin" id="formLogin" className="space-y-8" onSubmit={handleSubmit}>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <label htmlFor="email" className="block text-sm dark:text-white">Email</label>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <label htmlFor="senha" className="text-sm dark:text-white">Senha</label>
                        ...
                        <button type="submit" className="w-full px-8 py-3 font-sen text-2xl rounded-md bg-[#3EA0E7]  dark:bg-[#3EA0E7] text-white">Logar</button>
