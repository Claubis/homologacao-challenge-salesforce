            ...
            <div className="md:px-4 md:py-16 mx-auto md:space-y-8 flex flex-col justify-center gap-10 mt-10 md:mt-0">
                ...
                <div className="space-y-8 flex flex-col justify-center gap-10">
                        ...
                        <ul className="space-y-4">
                            <li className="space-y-1">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <h4 className="font-manrope text-md md:text-2xl leading-7 md:leading-10">Explore nossa página com facilidade! Você pode navegar usando a tecla TAB para mover o foco entre os campos. Cada elemento receberá destaque conforme você navega, facilitando a identificação. Se estiver usando um leitor de tela, ele irá descrever cada elemento à medida que você navega. Se preferir, também é possível usar o mouse para navegar, com conteúdos claros e dinâmicos que se destacam conforme você interage com eles.</h4>
                    ...
                    <div>
                        ...
                        <h3 className="mb-5 text-2xl md:text-4xll font-manrope text-red-700 dark:text-white">Tema</h3>
                    ...
                    <div>
                        ...
                        <h3 className="mb-5 text-2xl md:text-4xlfont-manrope text-red-700 dark:text-white">Idioma</h3>
                    ...
                    <div>
                        ...
                        <li className="space-y-1">
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <h4 className="font-manrope text-md md:text-2xl leading-7 md:leading-10">Suporte em Libras! Oferecemos suporte em Língua Brasileira de Sinais (Libras) para tornar nosso conteúdo acessível a pessoas surdas ou com deficiência auditiva. Com o suporte em Libras, você pode assistir a vídeos com tradução em Libras, garantindo que nosso conteúdo seja compreendido de forma clara e acessível. Estamos comprometidos em proporcionar uma experiência inclusiva para todos os usuários, independentemente de suas necessidades de acessibilidade.</h4>
                        ...
                        <div className="flex justify-start items-center gap-3 mb-5">
                                ...
                                <ul className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <h4 className="font-manrope text-md md:text-2xl leading-7 md:leading-10">Conheça nosso chatbot! Disponível 24 horas por dia, nosso chatbot está pronto para ajudar com informações sobre nossos produtos e até mesmo preencher formulários de contato. Com o chatbot, você pode escolher entre interagir por texto ou por áudio, recebendo respostas claras e úteis em ambos os formatos. Com uma ampla gama de funcionalidades, nosso chatbot oferece uma experiência de suporte completa e acessível, adaptada às suas preferências de comunicação.</h4>
                        ...
                        <div className="flex justify-start items-center gap-3 mb-5">
                                ...
                                <ul className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <h4 className="font-manrope text-md md:text-2xl leading-7 md:leading-10">Controle a fonte com facilidade! Ative a opção de aumentar ou diminuir a fonte dos textos usando apenas as teclas do teclado. Com a seta para cima, você aumenta o tamanho da fonte, e com a seta para baixo, você diminui. Uma vez ativada a opção, você terá esse recurso disponível em todas as páginas, permitindo uma experiência de leitura mais confortável e personalizada.</h4>
                        ...
                        <div className="flex justify-start items-center gap-3 mb-5">
                                ...
                                <ul className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <h4 className="font-manrope text-md md:text-2xl leading-7 md:leading-10">Assista a vídeos com acessibilidade! Nossos vídeos estão disponíveis com legendas para facilitar a compreensão. Além disso, oferecemos uma descrição do conteúdo abaixo do vídeo para explicar o que está sendo apresentado, caso a pessoa não possa ler as legendas. Dessa forma, garantimos que nosso conteúdo seja acessível a todos os públicos, independentemente de suas necessidades de acessibilidade.</h4>
                                    ...
                                    <li className="space-y-1 pb-20 md:pb-0">
                                        <div className="flex items-center space-x-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 fill-current dark:text-[#3EA0E7]">
                                                <path d="M426.072,86.928A238.75,238.75,0,0,0,88.428,424.572,238.75,238.75,0,0,0,426.072,86.928ZM257.25,462.5c-114,0-206.75-92.748-206.75-206.75S143.248,49,257.25,49,464,141.748,464,255.75,371.252,462.5,257.25,462.5Z"></path>
                                                <polygon points="221.27 305.808 147.857 232.396 125.23 255.023 221.27 351.063 388.77 183.564 366.142 160.937 221.27 305.808"></polygon>
