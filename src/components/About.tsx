            ...
            <div className="container grid justify-center md:gap-4 mx-auto lg:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="flex flex-col md:px-8 md:py-6 mt-10 md:mt-0">
                    ...
                    <TextReader text="Produtos">
                        <h2 className="mb-2 text-lg font-manrope sm:text-xl title-font dark:text-white">Produtos</h2>
                    </TextReader>     

                    <TextReader text="Escrever uma frase sobre diferencial dos produtos.">
                        <p className="flex-1 mb-4 leading-relaxed dark:text-white font-manrope">Por que a Salesforce é Diferente?</p>
                    </TextReader>
                ...
                <div className="flex flex-col md:px-8 md:py-6 mt-10 md:mt-0 lg:border-none xl:border-solid">
                    ...
                    <TextReader text="Serviços">
                        <h2 className="mb-2 text-lg font-manrope sm:text-xl title-font dark:text-white">Serviços</h2>
                    </TextReader>

                        <p className="flex-1 mb-4 text-base leading-relaxed font-manrope dark:text-white">Conheça sobre os serviços que fornecemos</p>


                    <Link className="inline-flex items-center space-x-2 text-sm dark:text-[#3EA0E7]" href="/Services">
                ...
                <TextReader text="CRM">
                    <h2 className="mb-2 text-lg font-manrope sm:text-xl title-font dark:text-white">CRM</h2>
                </TextReader>

                <TextReader text="Falar o que é o CRM e como isso agrega para cada empresa.">
                    <p className="flex-1 mb-4 text-base leading-relaxed dark:text-white font-manrope mt-5">O que é o CRM e como isso agrega para cada empresa?.</p>
                </TextReader>
                ...
                <TextReader text="Contato">
                    <h2 className="mb-2 text-lg font-manrope sm:text-xl title-font dark:text-white">Contato</h2>
                </TextReader>

                <TextReader text="Explicar as formas de contato para que cada cliente possa escolher um e entrar em contato.">
                    <p className="flex-1 mb-4 text-base leading-relaxed dark:text-white font-manrope">Saiba como entrar em contato</p>
                </TextReader>
